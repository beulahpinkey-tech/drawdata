...
const GAMES: { id: "pick3" | "pick4" | "powerball" | "megamillions"; label: string; tag: string; group: "wi" | "national" }[] = [
  { id: "pick3", label: "Wisconsin Pick 3", tag: "3-digit", group: "wi" },
  { id: "pick4", label: "Wisconsin Pick 4", tag: "4-digit", group: "wi" },
    ...
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-72 panel p-1 z-30">
          ...
          <div className="px-3 py-1.5 text-[10px] uppercase tracking-[0.16em] text-dim font-mono">Wisconsin state games</div>
