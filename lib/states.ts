...
export const STATE_GAMES: StateGame[] = [
  ...
  { state: "Florida", abbr: "FL", pick3Name: "Pick 3", pick4Name: "Pick 4", status: "waitlist" },
  ...
  { state: "North Carolina", abbr: "NC", pick3Name: "Carolina Pick 3", pick4Name: "Carolina Pick 4", status: "waitlist" },
